-- EJARI P0: centralized and atomic monthly invoice generation.
-- The function is the single source of truth for rent, utility and carry-forward calculation.
...
BEGIN
  ...
  -- Serialize generation per accounting period. The unique constraint on invoices
  -- remains the final protection against duplicate shop-period invoices.
  ...
  LOOP
    ...
    -- Only periods strictly before the target period are carried forward.
    ...
    INSERT INTO public.invoices (
      ...
      CASE WHEN v_total > 0 THEN 'unpaid' ELSE 'paid' END,
